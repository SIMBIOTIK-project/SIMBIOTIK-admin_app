...
class _$LoginImpl implements _Login {
  const _$LoginImpl({required this.name, required this.password});
...
/// @nodoc
mixin _$AuthState {
  GetAuthStateStatus get status => throw _privateConstructorUsedError;
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl(
      {this.status = GetAuthStateStatus.initial,
      this.data,
      this.token = '',
      this.error = ''});
  ...
  @override
  @JsonKey()
  final GetAuthStateStatus status;
  @override
  ...
  @override
  String toString() {
    return 'AuthState(status: $status, data: $data, token: $token, error: $error)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, data, token, error);
